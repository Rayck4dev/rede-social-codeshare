...
<div class="d-flex justify-content-center align-items-center vh-100 gradient-bg">
    <div class="card p-5 register-card">
        <div class="text-center mb-4">
            ...
            <p style="color: #8b949e;">Crie sua conta na CodeShare</p>
        </div>
        ...
        <form action="<?= base_url('registrar') ?>" method="post">
            <div class="mb-3">
                ...
                <input type="text" name="nome" class="form-control shadow-sm" placeholder="Dev Name" required>
            </div>
            ...
            <button type="submit" class="btn btn-tech w-100">Finalizar Cadastro</button>
        </form>

        <p class="mt-3 text-center" style="color: #8b949e;">Já tem conta?
...
<script>
    ...
    toggleBtn.addEventListener('click', () => {
        ...
        toggleBtn.textContent = isPassword ? '#' : '>_';
    });
